...
include(":feature:shared-transition:data")
include(":feature:shared-transition:domain")
include(":feature:shared-transition:presentation")
include(":feature:shared-transition:ui")
include(":feature:showcases:ui")
